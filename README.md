# yuno-learner
yuno-learner is an easy-to-use, lightweight and free desktop app for adults who need to relearn the alphabet.
...
This repository is [mirrored on Github](https://github.com/alsen-ca/learner), which is used to build the releases for Windows.
...
## Dev
    ...
    git clone https://codeberg.org/alsen-ca/learner.git
...
### Compiling
For those that can't or don't wish to install the binary directly, they can compile the app themselves.
...
### Icons
The frontend uses icons from [Lucide](https://lucide.dev/), licensed under the [ISC License](src/assets/LICENSE).
